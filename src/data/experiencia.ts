...
export const experiencia: EmpresaExperiencia[] = [
  ...
  },
  {
    ...
    stack: ['Node.js', 'TypeScript', 'Java', 'Spring', 'AWS', 'DynamoDB', 'Terraform', 'Angular.js', 'Jest', 'JUnit'],
    cargos: [
      {
        cargo: {
        ...
        destaques: {
          pt: [
            ...
            'Fui responsável por 15% de uma suíte com mais de 1500 testes unitários (Node.js, TypeScript, Jest), garantindo entregas estáveis em produção.',
          ],
          en: [
